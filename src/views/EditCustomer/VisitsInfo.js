...
class VisitsInfo extends Component {
  ...
  render() {
    ...
    let optionItems
    let {percentage,visit} = this.props
    var defaultRepresentative = null;
    
    if (isAvailable){
      let representatives = this.state.representatives[0].names;
      defaultRepresentative = representatives.indexOf(visit.representative)+1;
              ...
              <CardBody>
                  ...
                  <FormGroup row>
                    ...
                    <InputGroup>
                      ...
                      <Input type="number" id="percent" name="percentage" placeholder="Visits Percentage (0-100)" requiered onChange={(event) => this.handleChange1(event)} defaultValue = {percentage}/>
                    </InputGroup>
                  ...
                  <FormGroup row>
                    ...
                    <InputGroup>
                      ...
                      <Input type="date" id="date" name="date" placeholder="Date" requiered onChange={(event) => this.handleChange(event)} defaultValue = {visit.date}/>
                    </InputGroup>
                    </Col>
                  </FormGroup>
                  ...
                  <FormGroup row>
                    ...
                    <InputGroup>
                      ...
                      <Input type="select" name="respresentative" id="representative" requiered  onChange={(event) => this.handleSalesInput(event)} value = {defaultRepresentative} >
                  ...
                  <FormGroup row>
                    ...
                    <InputGroup>
                      ...
                      <Input type="number" id="net" name="net" placeholder="Net" requiered onChange={(event) => this.handleChange(event)} defaultValue = {visit.net}/>
                    </InputGroup>
                    <FormText className="help-block">Please used only numbers greater than 0</FormText>
                    </Col>
                  </FormGroup>
                  ...
                  <FormGroup row>
                    ...
                    <Col md="10">             
                      <Input type="number" id="totalVisit" name="totalVisit" disabled defaultValue = {visit.totalVisit} />
                    </Col> 
                  </FormGroup>
                  ...
                  <FormGroup row>
                    ...
                    <Col xs="12" md="10">
                      <Input type="textarea" name="description" id="textarea-input" rows="9"
                             placeholder="Content..." requiered onChange={(event) => this.handleChange(event)} defaultValue = {visit.description}/>
                    </Col>
                  </FormGroup>
